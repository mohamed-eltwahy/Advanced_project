...
class _SettingsPageState extends State<SettingsPage> {
  ...
  Widget build(BuildContext context) {
    return Center(
      ...
      children: [
        ListTile(
          leading: SvgPicture.asset(AssetsManaget.changeLangIc),
          title: Text(AppStrings.changeLanguage,
              style: Theme.of(context).textTheme.bodyLarge),
          trailing: Transform(
            alignment: Alignment.center,
            transform: Matrix4.rotationY(isRtl() ? math.pi : 0),
            child: SvgPicture.asset(AssetsManaget.rightArrowSettingsIc),
          ),
          onTap: () {
            _changeLanguage();
          },
        ...
        ListTile(
          leading: SvgPicture.asset(AssetsManaget.contactUsIc),
        ...
        ListTile(
          leading: SvgPicture.asset(AssetsManaget.inviteFriendsIc),
        ...
        ListTile(
          leading: SvgPicture.asset(AssetsManaget.logoutIc),
