...
import 'package:advanced_tips/presentation/modules/auth/register/register_viewmodel.dart';
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Flexible(child: SvgPicture.asset(AssetsManaget.photoCameraIc))
        ],
      ),
    );
  }
